  ...
  try {
    ...
    if (integratedRoot) {
      return {
        ...
        sql: await readFile(resolve(integratedRoot,
          'supabase/migrations/20260908145831_cs_lazada_v3_conversation_projection.sql'), 'utf8'),
      };
    }
    return {
...
const [v3Sql, projection, guardSql, adminSource, conversationRouteSource, conversationContractSource,
  ...
  readFile(new URL('../supabase/migrations/20260908153837_cs_lazada_ordinary_workspace_reply_guard.sql', import.meta.url), 'utf8'),
  ...
  await db.exec(`
    ...
    create function public.sellerpilot_create_support_reply_job(uuid,uuid,text,text,text)
      ...
      begin
        ...
        insert into sellerpilot_private.ai_cli_jobs values($1,'support_reply',jsonb_build_object(

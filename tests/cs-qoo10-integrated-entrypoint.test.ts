...
const credentialId = "40000000-0000-4000-8000-000000000010";
const ownerId = "50000000-0000-4000-8000-000000000010";
const replyJobId = "60000000-0000-4000-8000-000000000010";
const requeryJobId = "70000000-0000-4000-8000-000000000010";
...
async function run(options: { sequence?: string; transportFailure?: boolean; ownershipLost?: boolean } = {}) {
  ...
  const response = await runOneServerlessCsGatewayJob({
    ...
    rpc: async (name, args = {}) => {
      ...
      if (name === "sellerpilot_service_qoo10_reply_s3_requery_context_v1") return { data: {
        contract: "sellerpilot-qoo10-reply-s3-requery-context/1",
        sourceReadbackJobId: jobId,
        attemptNumber: 1,
        expectedLineageDigest: null,
        firstCheckedAt: "2026-09-08T13:00:00.000Z",
        lastCheckedAt: "2026-09-08T13:00:00.000Z",
        lineage: {
          ownerId,
          credentialId,
          ...
          deliveryId,
          replyJobId,
          inboundKey: "qoo10:inbound:fixture",
          searchStartAt: "20260908000000",
          searchEndAt: "20260908235959",
          target: { inquiryType: "MSG", questionNo: "700", sequenceNo: "701" },
        },
      }, error: null };
      if (name === "sellerpilot_service_apply_qoo10_reply_s3_requery_v1") {
        const descriptor = args.p_descriptor as Record<string, unknown>;
        const retry = descriptor.decision === "retry";
        return { data: {
          contract: "sellerpilot-qoo10-reply-s3-requery-result/1",
          status: retry ? "scheduled" : "verified",
          sourceReadbackJobId: jobId,
          deliveryId,
          attemptNumber: 1,
          lineageDigest: descriptor.lineageDigest,
          ...(retry ? { nextAttemptNumber: 2, requeryJobId } : {}),
          replayed: false,
        }, error: null };
      }

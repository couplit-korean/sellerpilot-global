...
test("Supabase migrations apply in order and core RPC flows persist safely", async () => {
  ...
  try {
    ...
    assert.deepEqual(migrationNames, [
      ...
      "20260905140000_preserve_unordered_lazada_messages.sql",
      "20260905141000_products_authoritative_inventory_bridge.sql",
      "20260905142000_lazada_durable_order_item_ownership.sql",
      "20260906010000_verify_channel_credential_owner.sql",
      "20260906011000_route_lazada_im_webhook_credentials.sql",
      "20260906030000_shopee_exact_oauth_executor.sql",
      "20260906040000_external_detail_import.sql",
      "20260906043000_external_detail_channel_fence.sql",
      "20260906050000_bind_lazada_oauth_to_authoritative_seller.sql",
      "20260906053000_external_detail_publication_lifecycle.sql",
      "20260906060000_lazada_exact_oauth_executor.sql",
      "20260906070000_evidence_based_global_publication_gate_counters.sql",
      "20260906204000_bind_external_detail_attempt_owner.sql",
      "20260906220000_allow_bound_smartstore_local_create_claim.sql",
      "20260906222500_preserve_external_detail_source_time_on_completion.sql",
      "20260906222700_allow_bound_coupang_category_local_claim.sql",
      "20260907023000_product_registration_drafts.sql",
      "20260907024000_product_registration_context.sql",
      "20260907031500_product_registration_role_claims.sql",
      "20260907052000_external_detail_content_approval_revision.sql",
      "20260907053000_allow_duplicate_external_source_hashes.sql",
      "20260907060844_read_lazada_quarantine.sql",
      "20260907100000_scope_cs_history_by_channel.sql",
      "20260907101000_read_cs_conversation_timeline.sql",
      "20260907102000_project_unsequenced_cs_answers.sql",
      "20260907103000_search_cs_archive.sql",
      "20260907103100_exact_smartstore_manual_adoption_receipt.sql",
      "20260907104000_keep_cs_history_from_resolving_new_requests.sql",
      "20260907105000_select_past_cs_history_windows.sql",
      "20260907110000_general_local_channel_executor.sql",
      "20260907112000_coupang_scoped_publication_gate.sql",
      "20260907120000_read_owned_ebay_message_accounts.sql",
      "20260907150000_verify_smartstore_manual_adoption_for_normal_update.sql",
      "20260907151000_smartstore_scoped_publication_gate.sql",
      "20260907160000_smartstore_adoption_gateway_readback.sql",
      "20260907161000_smartstore_local_update_executor.sql",
      "20260907170000_smartstore_readback_status_rpc_name.sql",
      "20260907171000_smartstore_official_get_identity.sql",
      "20260907172000_postgrest_safe_background_rpc_names.sql",
      "20260907174000_smartstore_existing_remote_content_repair.sql",
      "20260907175000_smartstore_repair_transport_provenance.sql",
      "20260907175100_smartstore_content_repair_reconciliation_recovery.sql",
      "20260907175200_smartstore_repair_uncertain_official_readback.sql",
      ...
      "20260907180000_allow_unbound_listing_create_local_claim.sql",
      "20260907180100_restore_shared_admin_cs_reads.sql",
      "20260907190000_preserve_undated_lazada_buyers.sql",
      "20260907191500_reconcile_exact_coupang_live_create_get_only.sql",
      "20260907194500_fix_exact_coupang_shared_admin_lineage.sql",
      "20260907200000_enable_shopee_comment_cs.sql",
      "20260907210000_persist_lazada_im_raw_inbox.sql",
      "20260907220000_complete_cs_archive_scope_and_media.sql",
      "20260907230000_add_lazada_im_raw_reprocessing_ledger.sql",
      "20260907231000_add_cs_history_coverage_ledger.sql",
      "20260907232000_add_cs_reply_remote_observation.sql",
      "20260907233000_add_provider_rate_budgets.sql",
      "20260907234000_add_cs_attachment_retention_ledger.sql",
      "20260907235000_add_cs_scope_health.sql",
      "20260908000000_add_cs_credential_capability_bindings.sql",
      "20260908001000_harden_cs_commerce_boundaries.sql",
      "20260908002000_add_cs_import_staging.sql",
      "20260908003000_separate_exact_coupang_live_verifier_lineage.sql",
      "20260908003100_add_cs_recovery_drills.sql",
      "20260908004500_fix_exact_coupang_live_verifier_empty_market.sql",
      "20260908011500_allow_exact_coupang_live_verifier_local_claim.sql",
      "20260908013000_hydrate_exact_coupang_local_verifier_claim.sql",
      "20260908024900_resolve_exact_coupang_scoped_gate.sql",
      "20260908034500_retire_exact_coupang_failed_completion_receipt.sql",
      "20260908043000_fix_exact_coupang_completion_service_role.sql",
      "20260908044000_enable_ebay_commerce_message_cs.sql",
      "20260908045000_recover_exact_coupang_verifier_after_role_guard.sql",
      "20260908045001_enable_shopee_return_refund_cs.sql",
      "20260908046000_enable_temu_after_sales_detail_cs.sql",
      "20260908047000_enable_coupang_after_sales_cs.sql",
      "20260908047100_extend_coupang_after_sales_history.sql",
      "20260908048000_enable_qoo10_claim_cs.sql",
      "20260908049000_enable_elevenst_product_qna_cs.sql",
      "20260908050000_capture_exact_coupang_invalid_completion.sql",
      "20260908051500_adjudicate_exact_coupang_live_divergence.sql",
      "20260908052500_rotate_exact_coupang_routes_to_f0.sql",
      "20260908053000_enqueue_exact_coupang_price_repair.sql",
      "20260908054500_rebind_exact_coupang_price_repair_without_publish_draft.sql",
      "20260908055000_allow_exact_coupang_price_repair_from_null_listing_lineage.sql",
      "20260908055500_bind_exact_coupang_price_repair_to_actual_attempt_schema.sql",
      "20260908060000_allow_exact_coupang_dead_worker_price_recovery.sql",
      "20260908061500_enqueue_exact_coupang_post_price_publication_verifier.sql",
      "20260908062500_bind_exact_coupang_post_price_verifier_route.sql",
      "20260908063000_recover_exact_coupang_post_price_source_vendor_identity.sql",
      "20260908064000_recover_exact_coupang_missing_item_product_identity.sql",
      "20260908065000_complete_exact_coupang_post_price_after_reaper.sql",
      "20260908070352_normalize_exact_coupang_listing_price_snapshot.sql",
      "20260908084220_smartstore_adoption_recheck_successor_exact_guard.sql",
      "20260908135249_ebay_case_dispute_history_ledger.sql",
      "20260908135323_ebay_case_dispute_history_read_v2.sql",
      "20260908140403_cs_smartstore_order_binding_v2.sql",
      "20260908140405_cs_smartstore_history_checkpoint.sql",
      "20260908140407_cs_smartstore_exact_history_window_v5.sql",
      "20260908140409_cs_lazada_im_ingest_v3.sql",
      "20260908140411_cs_elevenst_read_state_alimi_ledger.sql",
      "20260908140414_cs_temu_durable_detail_retry.sql",
      "20260908140416_cs_temu_detail_retry_replay.sql",
      "20260908140419_cs_qoo10_reply_s3_status.sql",
      "20260908140421_cs_qoo10_reply_s3_response_seal.sql",
      "20260908141312_cs_coupang_history_checkpoint.sql",
      "20260908141314_cs_coupang_authenticated_web_verification.sql",
      "20260908142023_cs_shopee_history_ledger.sql",
      "20260908142025_cs_shopee_target_refresh_cas.sql",
      "20260908142028_cs_shopee_history_start.sql",
      "20260908142029_cs_shopee_atomic_history_completion.sql",
      "20260908142530_cs_smartstore_checkpoint_run_scope_v2.sql",
      "20260908143355_cs_coupang_reply_readback.sql",
      ...
      "20260908151735_cs_shopee_history_date_intent_cutoff.sql",
      "20260908153341_cs_qoo10_reply_s3_actual_completion.sql",
      "20260908153837_cs_lazada_ordinary_workspace_reply_guard.sql",
      "20260908155617_cs_smartstore_continuation_safe_window_v7.sql",
      "20260908155620_cs_smartstore_checkpoint_deferred_cutoff_v4.sql",
      "20260908170140_isolate_cs_workspace_snapshot.sql",
      "20260908171055_isolate_commerce_workspace_snapshot.sql",
      "20260908172414_isolate_cs_reply_draft_queue.sql",
      "20260908183507_isolate_shipping_and_product_read_models.sql",
      "20260909193500_shopee_exact_target_lineage_v2.sql",
      "20260909203000_qoo10_lotte_existing_postwrite_reconciliation.sql",
      "20260909204000_shopee_exact_target_cache_receipt_v3.sql",
      "20260910010000_fence_smartstore_create_source_revision.sql",
      "20260910013000_bind_shopee_sg_create_execution_lineage.sql",
      "20260910014000_fence_smartstore_serverless_create_source_revision.sql",
      "20260910014500_elevenst_credential_version_cas.sql",
      "20260910020000_smartstore_get_successor_completion.sql",
      "20260910020500_coupang_durable_create_reconciliation.sql",
      "20260910021000_ebay_durable_publication_reconciliation.sql",
      "20260910021500_fence_coupang_create_source_revision.sql",
      "20260910022500_elevenst_new_product_server_sources.sql",
      "20260910023000_shopee_create_resume_reconciliation.sql",
      "20260910023500_qoo10_fulfillment_evidence.sql",
      "20260910025000_temu_create_authoritative_sources.sql",
      "20260910025500_fence_coupang_create_official_sources.sql",
      "20260910030000_elevenst_new_product_source_approval.sql",
      "20260910031000_smartstore_create_category_attribute_source.sql",
      "20260910031500_fence_coupang_create_official_sources_r7.sql",
      "20260910032000_smartstore_create_category_source_collector_context.sql",
      "20260910032500_fence_coupang_create_official_sources_r8.sql",
      "20260910033500_qoo10_gateway_create_atomic_recovery.sql",
      "20260910035500_smartstore_create_category_source_hardening.sql",
    ]);
    assert.ok(

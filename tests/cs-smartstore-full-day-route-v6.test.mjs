...
test("the actual integrated route keeps request-window checks while selecting checkpoint v4 and enqueue v7", async () => {
  ...
  assert.match(route, /current_cutoff_deferred_behind_older_exact_full_kst_day_windows/);
  ...
  assert.match(route, /next\.key !== `smartstore:history:v4:/);

...
export const aiGeneratedAssetSpecs = [
  ...
  },
  {
    ...
    role: "detail",
    label: "front or rear source label and visible-feature close-up",
    purpose: "source-pixel evidence of visible front or rear label, material and construction without inferred claims",
    shotClass: "source-front-feature-crop",
    ratio: "1:1",
    width: 1200,
    height: 1200,
    referenceRoles: ["label", "barcode", "back", "front", "main", "left", "right"],
    composition: "a close source-pixel crop of the verified front or rear package label or visible product feature; retain only facts physically present in the selected source and never reconstruct hidden areas",
    ...
    camera: "direct crop from the verified front or rear label or feature view; no synthetic camera rotation",
    mustDifferFrom: ["hero", "square", "detail-overview", "detail-package", "detail-material"],
    identityPolicy: { mode: "source-evidence", sourceRoles: ["label", "barcode", "back", "front", "main", "left", "right", "top", "bottom"], background: "#fafafa", fit: "inside", placement: { left: 0.03, top: 0.03, width: 0.94, height: 0.94 } },
  },
  {
    id: "detail-use",
    file: "detail-use.png",
  ...
  },
  {
    ...
    composition: "show only the selected supplied contents or package view; for a seller-confirmed single unit, preserve the verified whole item in the right-hand contents panel with left-side space reserved for HTML configuration copy; never add, remove, separate or duplicate a physical item",

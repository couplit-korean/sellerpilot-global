...
최신 중앙 통합과 잔여 작업은 [다섯 번째 검토](integrations/20260909-review-05.md)를 따른다. eBay 일반 등록을 추가 통합해 현재 흐름349/349·업무40/채널28·타입/lint/로컬 빌드를 통과했다. 기본 흐름 중앙통합7/8, 실제완료0/8이다. 추가 화면 통합과 폐기된 경로를 요구하는 테스트 정리는 남아 있으며 전체 제품 완료율로 환산하지 않는다.

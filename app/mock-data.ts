...
export type ChannelKey = "qoo10" | "shopee" | "lazada";
...
export const channels: Record<ChannelKey, { name: string; market: string; color: string; letter: string }> = {
...
export const products = [
  ...
  { id: "SP-240804-029", name: "레티놀 퍼밍 나이트 세럼", sku: "SK-RTN-30", image: productImages[1], stock: 64, sales: 84, revenue: "₩2,940,000", status: "판매중", channels: ["Q", "S", "L"] },
  { id: "SP-240801-014", name: "유기농 제주 말차 스틱 20포", sku: "FD-MTC-20", image: productImages[2], stock: 27, sales: 76, revenue: "₩2,128,000", status: "판매중", channels: ["Q", "S"] },
  { id: "SP-240729-005", name: "멀티비타민 미네랄 데일리", sku: "HL-MVM-60", image: productImages[3], stock: 9, sales: 61, revenue: "₩1,982,000", status: "재고주의", channels: ["S", "L"] },
];

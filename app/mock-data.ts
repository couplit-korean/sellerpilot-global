...
export const channels: Record<ChannelKey, { name: string; market: string; color: string; letter: string }> = {
  ...
  coupang: { name: "쿠팡", market: "대한민국", color: "#e8344e", letter: "C" },
  elevenst: { name: "11번가", market: "대한민국", color: "#ff2d55", letter: "11" },
  smartstore: { name: "네이버 스마트스토어", market: "대한민국", color: "#03c75a", letter: "N" },
  ebay: { name: "eBay Global", market: "글로벌", color: "#3665f3", letter: "E" },
};

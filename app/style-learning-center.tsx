    ...
    <div className="style-learning-page">
      <section className="style-learning-hero">
        <div>
          ...
          <p>
            ...
            실제 AI 등록 문안은 별도의 34개 채널·마켓 현지화 계약으로 생성합니다.
          </p>
        </div>
      ...
      <section className="style-learning-impact panel">
        ...
        <div className="style-learning-impact-grid">
          <article><b>SEO 상품명 · 34개</b><p>채널·마켓별 핵심 검색어 순서와 제목 길이 규칙을 적용하고 실제 등록 제목 필드로 전달합니다.</p></article>
          <article><b>상품 설명 · 34개</b><p>모바일 요약, 현지어 설명, 검색 키워드를 생성해 각 채널의 설명·검색 필드에 반영합니다.</p></article>
          <article><b>상세 텍스트 · 272개</b><p>서로 다른 구매 질문·근거를 담은 8개 섹션을 34개 채널·마켓 프로필별로 생성해 텍스트와 상세 이미지를 교차 배치합니다.</p></article>
          <article><b>이미지 SEO · 306개</b><p>대표 34개·상세 272개의 현지어 시각 의미를 사진 생성 프롬프트에 반영합니다. HTML alt 지원 채널에는 대체텍스트로, 미지원 채널에는 이미지 선택·순서 규칙으로 적용합니다.</p></article>
        </div>
      </section>

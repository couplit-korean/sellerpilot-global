...
const sections = [
  ...
  ["3. 처리 위치와 수탁자", "서비스는 Vercel의 미국 리전에서 애플리케이션 요청을 처리하고, Supabase의 싱가포르 리전에 운영 데이터와 암호화된 자격증명을 저장합니다. 각 공급자는 서비스 제공·보안·장애 복구 목적에 한해 데이터를 처리합니다."],
...
export default function PrivacyPage() {
  return <main className="privacy-page">
    ...
    <article>
      <p className="privacy-kicker">PUBLIC POLICY · EFFECTIVE 2026-08-18</p>

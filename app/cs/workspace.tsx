...
export function CsPage({ authenticatedFetch, notify, displayTickets, onSend, onDeliveryStatus, onDraft, onStatus, onSync, onBackfill, syncing, syncStatus, historyBackfill, snapshotGeneratedAt, initialQuery = "", initialTicketId = null, initialChannel = "all", initialStatus = "open", onFilterChange }: {
  ...
  return (
    <div className="page-stack cs-page">
      ...
      {selectedChannel === "coupang" || selectedChannel === "elevenst" || selectedChannel === "smartstore" ? <section className="panel cs-history-controls"><CsHistoryWindow authenticatedFetch={authenticatedFetch} onBackfill={onBackfill} disabled={syncing} channel={selectedChannel} /></section> : null}
      <CsChannelSlot channel={selectedChannel} authenticatedFetch={authenticatedFetch} />

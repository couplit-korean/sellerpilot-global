...
export const channelReadiness: ChannelReadiness[] = [
  ...
  },
  {
    ...
    appState: "판매자 로그인 확인 · Commerce API 계정 가입 대기",
    overall: "partial",
    summary: "스마트스토어 통합매니저 로그인과 Commerce API센터 접근을 확인했습니다. 개발업체 계정 생성 양식은 입력했지만 이메일 인증·자동화 입력 방지·필수 약관 동의가 남았고, 코드는 SELLER 토큰과 판매자 UID를 기준으로 보강했습니다.",
    checks: [
      { label: "판매자 세션", state: "verified", evidence: "Couplet Seoul 통합매니저 스마트스토어센터 로그인 확인" },
      { label: "API센터 세션", state: "verified", evidence: "동일 판매자 계정으로 Commerce API센터 가입 화면 접근" },
      ...
      { label: "개발업체 계정", state: "blocked", evidence: "이메일 인증번호·자동화 입력 방지·필수 약관 동의 후 가입 가능" },
      { label: "실계정 E2E", state: "not_configured", evidence: "애플리케이션 등록 후 Application ID·Secret·판매자 UID 연결 필요" },
    ],
    blockers: ["Commerce API센터 가입 본인확인과 필수 약관 동의", "내 스토어 애플리케이션 등록", "Application ID·Secret·판매자 UID를 Couplit Supabase Vault에 연결"],
    nextAction: "인증번호·자동화 확인·약관 동의 → 애플리케이션 등록 → SELLER 키 등록 → /v1/seller/account 실검수",
  },
  {
    key: "ebay",
    code: "E",

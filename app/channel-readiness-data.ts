...
export const channelReadiness: ChannelReadiness[] = [
  ...
  },
  {
    ...
    consoleVerified: false,
    apiReadPassed: true,
    summary: "운영 OPEN API Key와 등록 IP로 상품 읽기가 정상이며, 2026-08-24 케이블 정리 상품의 listing.create가 HTTP 200으로 완료되어 원격 상품번호가 작업 원장에 기록됐습니다. 다만 Seller Office 화면에서 해당 원격 상품을 다시 대조한 증거는 아직 남아 있지 않습니다.",
    checks: [
    ...
    blockers: ["CHANGHEE 프로필에서 원격 상품 화면 대조", "문의 조회 API 제공 범위 미확정", "실주문 부재로 발주·송장 쓰기 미검증"],
    nextAction: "기록된 원격 상품번호를 Seller Office 화면에서 대조 → 안전한 테스트 주문 발생 시 발주·송장 문서·권한부터 검수",
    officialDocs: [

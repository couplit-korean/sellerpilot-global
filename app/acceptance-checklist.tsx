  ...
  return (
    <div className="page-stack acceptance-page">
      <section className="acceptance-hero">
        ...
        <aside>
          <ShieldCheck size={21} />
          <div><strong>현재 단계 · 핵심 운영 연결과 실상품 검증 진행</strong><span>Qoo10 생성·재조회 완료 · Shopee 8개 숍 OAuth/UNLIST 검증 · Lazada MY 읽기 정상 · 채널별 미지원 범위는 별도 표시</span></div>
        </aside>
      </section>
      ...
      <section className="acceptance-gates">
        ...
        <i />
        <div><span>GATE 1</span><b>Qoo10·Shopee·Lazada API PoC</b><em>Qoo10 생성·재조회 · Shopee 8개 숍 · Lazada MY 읽기 통과</em></div>
        <i />
